            ...
            if(e.getSource() == guardar){
                ...
                try{                        
                    ...
                    if (cedulaText.getText().isEmpty()){
                        JOptionPane.showMessageDialog(this, "¿Cómo no va a tener cédula el candidato? Si es lo mas importante", "Error", JOptionPane.ERROR_MESSAGE);
                    ...
                    if (votos < 30){
                        JOptionPane.showMessageDialog(this, "¿Para qu te lanzaste a hacer campaña?","Error", JOptionPane.ERROR_MESSAGE);
